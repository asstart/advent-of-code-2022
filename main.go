...
func t18_1(o opts) string {
	res, err := adventofcode2022.Task18_1(
		&adventofcode2022.FileToStringsInputReader{Path: "adventofcode2022/day18.data"},
		adventofcode2022.ToArrPoint3D,
		o.D,
	)
	if err != nil {
		return err.Error()
